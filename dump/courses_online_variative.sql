...
--
-- Хост: MySQL-8.4
-- Время создания: Окт 18 2025 г., 14:24
...
(4, 2, '2025-10-20 13:49:15', 1, '2025-11-11', '00:00:00', 1, 4, NULL),
...
--
-- Структура таблицы `cancel_application`
--
...
--
-- Дамп данных таблицы `cancel_application`
--

INSERT INTO `cancel_application` (`application_id`, `comment`) VALUES
(4, 'фываф фывфыв фыв фыв фыв,\r\nфы\r\nва\r\nфы\r\nва\r\nфы\r\nва');
...
--
-- Индексы таблицы `cancel_application`
--
ALTER TABLE `cancel_application`
...
--
-- Ограничения внешнего ключа таблицы `cancel_application`
--
ALTER TABLE `cancel_application`
  ADD CONSTRAINT `cancel_application_ibfk_1` FOREIGN KEY (`application_id`) REFERENCES `application` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
